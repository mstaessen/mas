...
\begin{figure}[!h]
        ...
        \begin{center}
                ...
                \fbox{\includegraphics[width = 0.90\textwidth]{./images/feasibility.png}}
		\end{center}
...
\begin{figure}[!h]
        ...
        \begin{center}
       			\setlength\fboxsep{0.5pt}
				\setlength\fboxrule{0.5pt}
                \fbox{\includegraphics[width = 0.90\textwidth]{./images/exploration.png}}
		\end{center}
...
\begin{figure}[!h]
        ...
        \begin{center}
       			\setlength\fboxsep{0.5pt}
				\setlength\fboxrule{0.5pt}
                \fbox{\includegraphics[width = 0.90\textwidth]{./images/intention.png}}
		\end{center}
