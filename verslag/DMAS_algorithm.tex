...
\begin{figure}[!h]
        ...
        \begin{center}
                ...
                \fbox{\includegraphics[width = 0.9\textwidth]{./feasibility.png}}
		\end{center}
...
\begin{figure}[!h]
        ...
        \begin{center}
       			\setlength\fboxsep{0.5pt}
				\setlength\fboxrule{0.5pt}
                \fbox{\includegraphics[width = 0.9\textwidth]{./exploration.png}}
		\end{center}
...
\begin{figure}[!h]
        ...
        \begin{center}
       			\setlength\fboxsep{0.5pt}
				\setlength\fboxrule{0.5pt}
                \fbox{\includegraphics[width = 0.9\textwidth]{./intention.png}}
		\end{center}
